...
class PLController extends Controller
{
    ...
    public function index($idpl) {
        ...
        ")
        // ->from(DB::raw('( TRANS_PACKING_LIST_DETAIL.GROUP_PACKING, TRANS_PACKING_LIST_DETAIL.ITEM
        ...
        //     ) as tab1'))
        //     ->where ('TRANS_PACKING_LIST_HEADER.ID', '=', 'TRANS_PACKING_LIST_HEADER.ID' )
        ->selectRaw("
        TRANS_PACKING_LIST_DETAIL.GROUP_PACKING,  TRANS_PACKING_LIST_DETAIL.SJM_NOMER, TRANS_PACKING_LIST_DETAIL.ID_DETAIL_DATA_BARANG,
         TRANS_PACKING_LIST_DETAIL.ITEM, TRANS_PACKING_LIST_DETAIL.QTY_KIRIM")
