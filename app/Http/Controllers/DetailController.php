...
class DetailController extends Controller
{
    ...
    public function index($idpl) {
            ...
            // iki bener, tapi foreach 1
       
        // foreach($data as &$result) 
        // { 
        //     $result['DETAIL_BARANG'] = 
        //     [
        //         'ID_DETAIL_DATA_BARANG' => $result['ID_DETAIL_DATA_BARANG'], 
        //         'ITEM' => $result['ITEM'], 
        //         'PANJANG' => $result['PANJANG'],
        //         'LEBAR' => $result['LEBAR'],
        //         'TINGGI' => $result['TINGGI']
        //     ]; 
        //     unset($result['ID_DETAIL_DATA_BARANG'], $result['ITEM'], $result['PANJANG'], $result['LEBAR'], $result['TINGGI']);

        // }
        
        $keong = $data->groupBy('GROUP_PACKING');

        return response()->json($keong);
      }
}
