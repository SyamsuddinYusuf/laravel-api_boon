...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        DATA PACKING LIST DAN CONTAINER
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>VOLUME</th>
                  <th>BERAT</th>
                  <th>VOLUME PERSATUAN</th>
                  <th>BERAT PERSTUAN</th>
                  <th>QTY</th>
                  <th>SATUAN</th>
                </tr>
                </thead>
                ...
                <tr>
                  ...
                  <td align=center>{{ $p2->SJM_NOMER}}</td>
                  <td align=center>{{ $p2->ID_DETAIL_DATA_BARANG}}</td>
                  <td align=center>{{ $p2->ITEM}}</td>
                  <td align=center>{{ number_format(floatval($p2->PANJANG), 3) }}</td>
                  <td align=center>{{ number_format(floatval($p2->LEBAR), 3) }}</td>
                  <td align=center>{{ number_format(floatval($p2->TINGGI), 3) }}</td>
                  <td align=center>{{ number_format(floatval($p2->VOLUME), 3) }}</td>
                  <td align=center>{{ number_format(floatval($p2->BERAT), 3) }}</td>
                  <td align=center>{{ number_format(floatval($p2->VOLUME_PERSATUAN), 3) }}</td>
                  <td align=center>{{ number_format(floatval($p2->BERAT_PERSATUAN), 3) }}</td>
                  <td align=center>{{ $p2->QTY_KIRIM }}</td>
                  <td align=center>{{ $p2->SATUAN }}</td>
                </tr>
                @endforeach
                </tbody>
                <!-- <tfoot>
